...
@section('content')
    <main class="Home row" id="Home">
        ...
        <div class="Face" id="Face">
            ...
            <div class="fb-like" data-href="https://www.facebook.com/TrocipolloColombia/" data-width="400px" data-layout="button" data-action="like" data-size="large" data-show-faces="false" data-share="false"></div>
            <div id="fb-root"></div>
